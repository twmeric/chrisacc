...
import { getMarkdownContent, getJsonContent, getAllMarkdownFiles } from "@/lib/cms";
...
const heroSlides: Record<Locale, { title: string; subtitle: string; cta: string; href: string }[]> = {
  "zh-hant": [
    { title: "專業會計服務", subtitle: "提供全面的審計、稅務及顧問服務，助您的業務穩健發展", cta: "了解更多", href: "/services/audit/" },
  ...
  "zh-hans": [
    { title: "专业会计服务", subtitle: "提供全面的审计、税务及顾问服务，助您的业务稳健发展", cta: "了解更多", href: "/services/audit/" },
  ...
  en: [
    { title: "Professional Accounting Services", subtitle: "Comprehensive audit, tax, and advisory services to help your business thrive", cta: "Learn More", href: "/services/audit/" },
...
export default async function HomePage({ params }: HomePageProps) {
  ...
  return (
    <>
      <HeroSlider lang={lang} slides={heroSlides[lang]} />
