...
export const defaultCMSData: CMSData = {
  "zh-hant": {
    ...
    about: {
      ...
      missionVision: {
        items: [
          { icon: "Target", title: "我們的使命", desc: "致力於為客戶提供最優質的專業服務，協助企業達成財務目標，創造可持續的商業價值，成為客戶最信賴的財務夥伴。" },
          { icon: "Eye", title: "我們的願景", desc: "成為香港及亞太區領先的專業會計及商業顧問服務機構，以創新思維及專業精神，為客戶創造卓越價值。" },
          { icon: "ShieldCheck", title: "我們的承諾", desc: "堅持誠信、專業、保密的原則，以客戶利益為先，確保每一項服務都達到最高標準，讓客戶安心信賴。" },
        ],
      },
      coreValues: {
        title: "核心價值",
        ...
        items: [
          ...
          { icon: "Shield", title: "誠信正直", desc: "堅守職業道德，以誠信贏得客戶信賴" },
  ...
  "zh-hans": {
    ...
    about: {
      ...
      missionVision: {
        items: [
          { icon: "Target", title: "我们的使命", desc: "致力于为客户提供最优质的专业服务，协助企业达成财务目标，创造可持续的商业价值，成为客户最信赖的财务伙伴。" },
          { icon: "Eye", title: "我们的愿景", desc: "成为香港及亚太区领先的专业会计及商业顾问服务机构，以创新思维及专业精神，为客户创造卓越价值。" },
          { icon: "ShieldCheck", title: "我们的承诺", desc: "坚持诚信、专业、保密的原则，以客户利益为先，确保每一项服务都达到最高标准，让客户安心信赖。" },
        ],
      },
      coreValues: {
        title: "核心价值",
        ...
        items: [
          ...
          { icon: "Shield", title: "诚信正直", desc: "坚守职业道德，以诚信赢得客户信赖" },
  ...
  en: {
    ...
    about: {
      ...
      missionVision: {
        items: [
          { icon: "Target", title: "Our Mission", desc: "Dedicated to providing clients with the highest quality professional services, helping businesses achieve financial goals, creating sustainable commercial value, and becoming the most trusted financial partner." },
          { icon: "Eye", title: "Our Vision", desc: "To become a leading professional accounting and business advisory firm in Hong Kong and the Asia-Pacific region, creating exceptional value for clients through innovative thinking and professionalism." },
          { icon: "ShieldCheck", title: "Our Commitment", desc: "Upholding the principles of integrity, professionalism, and confidentiality, putting client interests first, and ensuring every service meets the highest standards." },
        ],
      },
      coreValues: {
        title: "Core Values",
        ...
        items: [
          { icon: "Award", title: "Excellence", desc: "Continuously improving professional capabilities and pursuing service excellence" },
          { icon: "Shield", title: "Integrity", desc: "Upholding professional ethics and winning client trust through integrity" },
          { icon: "Lightbulb", title: "Innovation", desc: "Using innovative methods to create greater value for clients" },
          { icon: "Users", title: "Teamwork", desc: "Harnessing team strength to achieve client goals together" },
        ],
      },
      team: {
