  ...
  "zh-hant": {
    ...
    about: {
      ...
      timeline: {
        ...
        events: [
          ...
          { year: "2010", title: "業務擴展", desc: "成功拓展稅務諮詢及商業顧問服務，客戶數量突破100家。" },
          { year: "2015", title: "團隊壯大", desc: "專業團隊增至30人，服務範圍擴展至企業併購及法證會計服務。" },
          { year: "2020", title: "數碼轉型", desc: "引入先進的數碼化系統，提升服務效率，為客戶提供更便捷的服務體驗。" },
          { year: "2025", title: "邁向未來", desc: "服務客戶超過500家，專業團隊增至50人，繼續致力於為客戶創造價值。" },
        ],
      },
      cta: {
        title: "與我們攜手合作",
      ...
      audit: {
        ...
        overviewStats: [
          { number: "98%", label: "客戶滿意度", position: "bottom" },
        ],
        overviewIcon: "CheckCheck",
        overviewImage: "",
        scopeTitle: "服務範圍",
      ...
      tax: {
        ...
        overviewStats: [
          { number: "50+", label: "國家稅務經驗", position: "top" },
          { number: "$2B+", label: "累計節稅金額", position: "bottom" },
        ],
      ...
      risk: {
        ...
        overviewStats: [
          { number: "200+", label: "合規項目經驗", position: "top" },
          { number: "100%", label: "監管檢查通過率", position: "bottom" },
        ],
        overviewIcon: "Shield",
        overviewImage: "",
        scopeTitle: "服務範圍",
      ...
      forensic: {
        ...
        overviewStats: [
          { number: "150+", label: "調查案件經驗", position: "top" },
          { number: "$500M+", label: "追回資產價值", position: "bottom" },
        ],
        overviewIcon: "Search",
        overviewImage: "",
        scopeTitle: "服務範圍",
    ...
    extraSections: [
      ...
      consulting: {
        ...
        overviewStats: [
          { number: "40%", label: "平均效率提升", position: "top" },
          { number: "100+", label: "轉型項目經驗", position: "bottom" },
        ],
        overviewIcon: "Settings",
        overviewImage: "",
        scopeTitle: "服務範圍",
      ...
      deals: {
        ...
        overviewStats: [
          { number: "DD", label: "盡職調查", position: "top" },
          { number: "PPA", label: "購買價格分攤", position: "bottom" },
        ],
        overviewIcon: "Handshake",
        overviewImage: "",
        scopeTitle: "服務範圍",
    ...
    about: {
      ...
      timeline: {
        ...
        events: [
          ...
          { year: "2010", title: "业务扩展", desc: "成功拓展税务咨询及商业顾问服务，客户数量突破100家。" },
          { year: "2015", title: "团队壮大", desc: "专业团队增至30人，服务范围扩展至企业并购及法证会计服务。" },
          { year: "2020", title: "数码转型", desc: "引入先进的数码化系统，提升服务效率，为客户提供更便捷的服务体验。" },
          { year: "2025", title: "迈向未来", desc: "服务客户超过500家，专业团队增至50人，继续致力于为客户创造价值。" },
        ],
      },
      cta: {
        title: "与我们携手合作",
      ...
      audit: {
        ...
        overviewStats: [
          { number: "98%", label: "客户满意度", position: "bottom" },
        ],
        overviewIcon: "CheckCheck",
        overviewImage: "",
        scopeTitle: "服务范围",
      ...
      tax: {
        ...
        overviewStats: [
          { number: "多區", label: "国际税务架构", position: "top" },
          { number: "TP", label: "转让定价", position: "bottom" },
        ],
        overviewIcon: "FileText",
        overviewImage: "",
        scopeTitle: "服务范围",
      ...
      risk: {
        ...
        overviewStats: [
          { number: "ERM", label: "企业风险管理", position: "top" },
          { number: "ICFR", label: "内部控制审查", position: "bottom" },
        ],
        overviewIcon: "Shield",
        overviewImage: "",
        scopeTitle: "服务范围",
      ...
      forensic: {
        ...
        overviewStats: [
          { number: "AML", label: "反洗钱合规", position: "top" },
          { number: "CTF", label: "反恐融资", position: "bottom" },
        ],
        overviewIcon: "Search",
        overviewImage: "",
        scopeTitle: "服务范围",
      ...
      consulting: {
        ...
        overviewStats: [
          { number: "ERP", label: "系统实施", position: "top" },
          { number: "CFO", label: "财务顾问", position: "bottom" },
        ],
        overviewIcon: "Settings",
        overviewImage: "",
        scopeTitle: "服务范围",
      ...
      deals: {
        ...
        overviewStats: [
          { number: "DD", label: "尽职调查", position: "top" },
          { number: "PPA", label: "购买价格分摊", position: "bottom" },
        ],
        overviewIcon: "Handshake",
        overviewImage: "",
        scopeTitle: "服务范围",
  ...
  en: {
    ...
    about: {
      ...
      audit: {
        ...
        overviewStats: [
          { number: "98%", label: "Client Satisfaction", position: "bottom" },
        ],
        overviewIcon: "CheckCheck",
        overviewImage: "",
      ...
      tax: {
        ...
        overviewStats: [
          { number: "Multi", label: "International Tax Structures", position: "top" },
          { number: "TP", label: "Transfer Pricing", position: "bottom" },
        ],
        overviewIcon: "FileText",
        overviewImage: "",
        scopeTitle: "Service Overview",
      ...
      risk: {
        ...
        overviewStats: [
          { number: "ERM", label: "Enterprise Risk Management", position: "top" },
          { number: "ICFR", label: "Internal Control Review", position: "bottom" },
        ],
        overviewIcon: "Shield",
        overviewImage: "",
        scopeTitle: "Service Overview",
      ...
      forensic: {
        ...
        overviewStats: [
          { number: "AML", label: "Compliance", position: "top" },
          { number: "CTF", label: "Counter-Terrorist Financing", position: "bottom" },
        ],
        overviewIcon: "Search",
        overviewImage: "",
        scopeTitle: "Service Overview",
      ...
      consulting: {
        ...
        overviewStats: [
          { number: "ERP", label: "System Implementation", position: "top" },
          { number: "CFO", label: "Finance Advisory", position: "bottom" },
        ],
        overviewIcon: "Settings",
        overviewImage: "",
        scopeTitle: "Service Overview",
      ...
      deals: {
        ...
        overviewStats: [
          { number: "DD", label: "Due Diligence", position: "top" },
          { number: "PPA", label: "Purchase Price Allocation", position: "bottom" },
        ],
        overviewIcon: "Handshake",
        overviewImage: "",
        scopeTitle: "Service Overview",
