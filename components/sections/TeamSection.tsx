...
const content: Record<string, { title: string; subtitle: string; members: { name: string; role: string; image: string }[] }> = {
  "zh-hant": {
    ...
    members: [
      { name: "陳大文", role: "創辦人及執行董事", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop" },
      { name: "李美琪", role: "審計總監", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop" },
      { name: "張志偉", role: "稅務合夥人", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=500&fit=crop" },
      { name: "王曉明", role: "諮詢總監", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=500&fit=crop" },
    ],
  },
  "zh-hans": {
    title: "专业团队",
    ...
    members: [
      { name: "陈大文", role: "创办人及执行董事", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop" },
      { name: "李美琪", role: "审计总监", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop" },
      { name: "张志伟", role: "税务合伙人", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=500&fit=crop" },
      { name: "王晓明", role: "咨询总监", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=500&fit=crop" },
    ],
  },
  en: {
    ...
    members: [
      { name: "David Chan", role: "Founder & Executive Director", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop" },
      { name: "Maggie Lee", role: "Audit Director", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop" },
      { name: "Peter Cheung", role: "Tax Partner", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=500&fit=crop" },
      { name: "Raymond Wong", role: "Advisory Director", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=500&fit=crop" },
    ],
  },
};
