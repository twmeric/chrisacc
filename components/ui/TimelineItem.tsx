...
export default function TimelineItem({ year, title, description, side }: TimelineItemProps) {
  return (
    <div className="relative mb-8 md:mb-10">
      {/* Dot on the timeline */}
      <span className="absolute left-5 top-[24px] z-10 h-5 w-5 -translate-x-1/2 rounded-full border-4 border-white bg-brand-gold shadow md:left-1/2 md:-translate-x-1/2" />
      ...
      >
        <div className={`w-full md:w-[48%] ${side === "left" ? "md:pr-8" : "md:pl-8"}`}>
          <div
